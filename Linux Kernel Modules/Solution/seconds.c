...
unsigned long start , end ; // to store jiffies at load and unload
...
ssize_t proc_read(struct file *file, char __user *usr_buf, size_t count, loff_t *pos)
{
	...
	// number of seconds that have elapsed since the kernel module was first loaded

	end = jiffies ;

        rv = sprintf(buffer, "Number of seconds elapsed: %lu\n", (end - start) / HZ);
